    ...
    public partial class Emit<DelegateType>
    {
        ...
        public Emit<DelegateType> StoreArgument(ushort index)
        {
            ...
            if (index >= byte.MinValue && index <= byte.MaxValue)
            {
                ...
                UpdateState(OpCodes.Starg_S, asByte, StackTransition.Pop(ParameterTypes[index]).Wrap("StoreArgument"), pop: 1);
                return this;
            }
            ...
            UpdateState(OpCodes.Starg, asShort, StackTransition.Pop(ParameterTypes[index]).Wrap("StoreArgument"), pop: 1);
