...
namespace SigilTests
{
    public partial class TypedReferences
    {
        ...
        public void MakeRefNonGeneric()
        {
            ...
            var d1 = e1.CreateDelegate<Func<int?, int>>(out string instrs);
        ...
        public void RefValueNonGeneric()
        {
            ...
            var d1 = e1.CreateDelegate<Func<int>>(out string instrs);
        ...
        public void RefTypeNonGeneric()
        {
            ...
            var d1 = e1.CreateDelegate<Func<Type>>(out string instrs);
